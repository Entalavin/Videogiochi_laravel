...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-primary-subtle px-1 fs-3 text-uppercase" data-bs-theme="dark" style="padding-top: 20px; padding-bottom: 20px">
        <div class="container-fluid">
          <a class="navbar-brand fs-3 text-uppercase mx-5" href="{{route('home')}}">Home</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 mx-5">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="{{route ('videogames')}}">Videogiochi</a>
              </li>
              <li class="nav-item">
    ...
    <main class="sfondo-main" style="background-color: rgb(165, 219, 240)">
            @yield('content')
    </main>
